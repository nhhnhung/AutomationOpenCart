...
public class LibraryHelper {
    ...
    public static void waitForElementVisible(By by) {
        try {
            ...
            throw new RuntimeException("Timeout waiting for the element Visible. " + by.toString());
        }
    }
    ...
    public static void waitForElementPresent(By by) {
        try {
            ...
            throw new RuntimeException("Element not exist. " + by.toString());
        }
    }
    ...
    public static void waitForElementClickable(By by) {
        try {
            ...
            throw new RuntimeException("Timeout waiting for the element ready to click. " + by.toString());
        }
    }
